...
$\sim 25\%$ of its norm in the imaginary part (after global phase
alignment), stable across all system sizes tested. However, when a
...
part, \textbf{stable from $d_{\mathrm{env}} = 2$ through $16$} with
contracting variance ($\pm 0.003$ at $N = 256$). The Riemannian
...
self-consistency map produces complex fixed points with $\sim 25\%$
imaginary content, stable through $N = 256$; the marginals satisfy
...
$\psi^*$ retains $\sim 25\%$ imaginary norm at all sizes tested through
$N = 256$, while the Riemannian $\psi^*$ is exactly real. The
...
$\psi^*$ retains $\sim 25\%$ imaginary norm (after global phase
alignment) at all sizes tested through $N = 256$, while the Riemannian
