...
(Proposition~\ref{prop:lor_quantum}) are all Rigorous. The remaining
open question is whether the conditional density matrix $\rho_{S|c}$
(eq.~\ref{eq:cond_dm}) converges to the standard Page--Wootters form in
appropriate limits---i.e., whether the $c$-dependence reduces to unitary
time evolution for semiclassical clock subsystems.
